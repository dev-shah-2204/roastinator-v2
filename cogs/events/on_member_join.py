            ...
            try:
                ...
                try:
                    ...
                    def check(message: discord.Message) -> bool:
                        return message.author == member.guild.owner and message.guild == member.guild

                    message = await self.client.wait_for('message', check=check)
                    await message.channel.send(f"<@!{member.guild.owner.id}>, you setup the auto-role but either I don't have permissions to Manage Roles or my role is too low. Put my role above the role that you want me to assign to the users. Since your DMs are closed, I had to reply this way")
